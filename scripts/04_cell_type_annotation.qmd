...
ggsave(plot = plot_reduction_025, 
       file = "../results/annotation/clustering without annotation.jpg",  
       height = 10, 
       width = 20, 
       units = "cm")
...
ggsave(plot = lymfoid_violin_plot, 
       file = "../results/annotation/Violin plot of lymphoid cell features for clustering.jpg", 
       width = 20, 
       height = 10, 
       units = "cm")
...
ggsave(plot = umap_w_annotations, 
       filename = "../results/annotation/UMAP cell annotations.jpg", height = 10, width = 20, units = "cm")
```
...
heatmap_top_3_genes <- Seurat::DoHeatmap(object = obj, features = top10_diff$gene, 
                  cells = 1:500, 
                  angle = 90, 
                  size = 4, 
                  label = FALSE, 
...
ggsave(plot = heatmap_top_3_genes, 
       file = "../results/annotation/Heatmap top 3 genes per cluster.jpg", 
       height = 15, 
       width = 20, 
       units = "cm")
```
